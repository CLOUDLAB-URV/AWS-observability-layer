...
- Keep the action segment concise so ELK can route cleanly; one segmented label per connection. The layout is computed with the labels REMOVED, so the text has to fit into whatever gap the packed diagram leaves — a short action fits, a long one has to be squeezed in and may end up sitting close to an icon. Brevity here is what keeps the diagram both compact and readable.
...
client -> aws.vpc_0abc.subnet_1a2b.app_alb__subnet_1a2b: "1 || HTTPS request" { style.stroke: "#e6edf3"; style.stroke-width: 2; style.font-color: "#c9d1d9"; style.font-size: 15; style.fill: "#0d1117" }
client -> aws.vpc_0abc.subnet_3c4d.app_alb__subnet_3c4d: "1 || HTTPS request" { style.stroke: "#e6edf3"; style.stroke-width: 2; style.font-color: "#c9d1d9"; style.font-size: 15; style.fill: "#0d1117" }
aws.vpc_0abc.subnet_1a2b.app_alb__subnet_1a2b -> aws.data.orders_table: "2 || Read/write" { style.stroke: "#e6edf3"; style.stroke-width: 2; style.font-color: "#c9d1d9"; style.font-size: 15; style.fill: "#0d1117" }
aws.vpc_0abc.subnet_3c4d.app_alb__subnet_3c4d -> aws.data.orders_table: "2 || Read/write" { style.stroke: "#e6edf3"; style.stroke-width: 2; style.font-color: "#c9d1d9"; style.font-size: 15; style.fill: "#0d1117" }
aws.vpc_0abc.subnet_1a2b.nat_0c1d -> aws.vpc_0abc.subnet_3c4d.app_alb__subnet_3c4d: "3 || Egress to internet || back" { style.stroke: "#e6edf3"; style.stroke-width: 2; style.font-color: "#c9d1d9"; style.font-size: 15; style.fill: "#0d1117" }
```
