...
aws.vpc_0abc.subnet_1a2b.app_alb__subnet_1a2b -> aws.data.orders_table: "2 || Read/write orders" { style.stroke: "#e6edf3"; style.stroke-width: 2; style.font-color: "#c9d1d9"; style.font-size: 15; style.fill: "#0d1117" }
aws.vpc_0abc.subnet_3c4d.app_alb__subnet_3c4d -> aws.data.orders_table: "2 || Read/write orders" { style.stroke: "#e6edf3"; style.stroke-width: 2; style.font-color: "#c9d1d9"; style.font-size: 15; style.fill: "#0d1117" }
