...
- Do NOT draw Security Groups, AMIs, Route Tables, ENIs, NAT/Internet Gateways as boxes or nodes — VPCs and subnets are the ONLY network primitives that get drawn. Whatever the inventory says about the others stays in the resource record the user reads by clicking the box.
